...
write.table(a19,featureFileSave,quote=FALSE,sep=",")
...
write.table(a21,featureFileSave,quote=FALSE,sep=",")
...
write.table(a25,featureFileSave,quote=FALSE,sep=",")
...
write.table(a29,featureFileSave,quote=FALSE,sep=",")
...
write.table(a31,featureFileSave,quote=FALSE,sep=",")
...
write.table(a39,featureFileSave,quote=FALSE,sep=",")
...
write.table(a41,featureFileSave,quote=FALSE,sep=",")
...
write.table(a43,featureFileSave,quote=FALSE,sep=",")
...
write.table(a45,featureFileSave,quote=FALSE,sep=",")
...
codonwFile=paste("",fileCondon,sep="")
...
#print(dim(x2))
#print(dim(x3))
print("Fin extraction des features avec protr")
